...
@endif
<section id="intro" style="display: flex; flex-direction: column; justify-content: space-between; padding: 0; background: url('{{ asset('vidk.jpg') }}') top center no-repeat; background-size:cover">
